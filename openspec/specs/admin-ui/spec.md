...
- **WHEN** `pnpm --filter @opencg/admin-ui build-storybook` is run after this change ships
...
- **AND** Storybook builds without error under `pnpm --filter @opencg/admin-ui build-storybook`
