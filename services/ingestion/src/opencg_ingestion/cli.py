...
import click
from opencg_shared import load_config

from opencg_ingestion.pipeline_runner import run_sync
from opencg_ingestion.reextract import reextract_sync


@click.group()
def main() -> None:
    """openCG ingestion CLI."""
